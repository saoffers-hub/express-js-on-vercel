...
const app = express();
// const { sql } = require('@vercel/postgres'); // Comentado pra evitar erro

const bodyParser = require('body-parser');
const path = require('path');
const fetch = require('node-fetch'); // Adicionado se estiver faltando
...
// Desabilitado temporariamente pra evitar erro de conexão
